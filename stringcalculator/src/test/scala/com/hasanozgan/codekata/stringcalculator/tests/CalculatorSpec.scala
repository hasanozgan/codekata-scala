package com.hasanozgan.codekata.stringcalculator.tests

import org.specs2.mutable._
import org.specs2.matcher.DataTables
import com.hasanozgan.codekata.stringcalculator.Calculator
import com.hasanozgan.codekata.stringcalculator.NegativeInputException

class CalculatorSpec extends Specification with DataTables {
  "String Calculator " should {
    ...
    "should return sum for unknown amount of numbers" in {
      ...
      "100,150" !! 250 |
      "5,10,15,20" !! 50 |> { 
        (input, result) => Calculator.add(input) must be equalTo (result)
      }
    }
    ...
    "should not sum up negatives" in {
      Calculator.add("1,-4,1") must throwA[NegativeInputException]
    }
  }
}
